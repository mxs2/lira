        ...
        <div className="relative p-5 z-[1] w-full max-w-md">
          ...
          >
            ...
            <button
              ...
              className={`w-full px-0 py-4 text-base font-semibold leading-6 text-white bg-indigo-700 rounded-lg transition-all cursor-pointer border-[none] duration-[0.2s] hover:bg-indigo-600 ${isSubmitting ? "opacity-70 cursor-not-allowed" : ""}`}
            >
              {isSubmitting ? (
