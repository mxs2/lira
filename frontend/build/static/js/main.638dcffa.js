/*! For license information please see main.638dcffa.js.LICENSE.txt */
(() => {
  "use strict";
  var e = {
      4: (e, t, n) => {
        ...
        function Ur(e, t, n, r, l, a) {
          ...
          if (((r = e), "function" === typeof e)) Mr(e) && (i = 1);
            ...
            e: switch (e) {
              ...
              case x:
                return (
                  ((e = Fr(13, n, t, l)).elementType = x), (e.lanes = a), e
                );
              case E:
                return (
                  ((e = Fr(19, n, t, l)).elementType = E), (e.lanes = a), e
                );
              default:
                if ("object" === typeof e && null !== e)
                  switch (e.$$typeof) {
        ...
        function $i(e, t, n) {
          ...
          if (null !== (u = e.memoizedState) && null !== (s = u.dehydrated)) {
            if (i)
              ...
              (Pi || xl(e, t, n, !1), (r = 0 !== (n & e.childLanes)), Pi || r)
            ) {
              if (
                null !== (r = rs) &&
                0 !==
        ...
        function Yi(e, t, n) {
          if (
            ...
            if (null === e) return null;
            if ((xl(e, t, n, !1), 0 === (n & t.childLanes))) return null;
          }
        ...
        function Gi(e, t) {
          return (
            0 !== (e.lanes & t) || !(null === (e = e.dependencies) || !El(e))
          );
        }
        function Xi(e, t, n) {
          if (null !== e)
            ...
            case 3:
              e: {
                ...
                if (
                  ...
                  if (r !== l) {
                    hl((l = Er(Error(o(424)), t))), (t = Ii(e, t, r, n));
                    break e;
                  }
          ...
          for (
            ...
            if (((n = e.current.alternate), !a || js(n))) {
              ...
              e: {
                ...
                } else Is(r, n, bs, xs, ks, t, gs, ms, ys, us, a, 0, -0, 0);
              }
              break;
            }
            (l = Ks(e, t, !1)), (a = !1);
        ...
        function Js(e, t, n, r) {
          ...
          try {
            if (
                  ...
                  return (
                    null !== (t = li.current)
                      ? (0 === (65536 & t.flags) && (t.flags |= 256),
                        ...
                        (t.lanes = l),
                        r !== ul &&
                          hl(Er((e = Error(o(422), { cause: r })), n)))
                      : (r !== ul &&
                          hl(Er((t = Error(o(423), { cause: r })), n)),
                        ((e = e.current.alternate).flags |= 65536),
                        (l &= -l),
                        (e.lanes |= l),
                        (r = Er(r, n)),
                        ia(e, (l = xi(e.stateNode, r, l))),
                        4 !== ds && (ds = 2)),
                    !1
                  );
              ...
              return (ds = 1), wi(e, Er(n, e.current)), void (ls = null);
          } catch (a) {
                ...
                !(function (e, t) {
                  ...
                  for (
                    ...
                    if (
                      ...
                      for (; null !== xu; ) {
                        switch (
                          ((a = (t = xu).alternate), (e = t.flags), t.tag)
                        ) {
                          case 0:
                          case 11:
                          case 15:
  ...
  (n.m = e),
    ...
    (n.u = (e) => "static/js/" + e + ".12e5533c.chunk.js"),
    (n.miniCssF = (e) => {}),
    ...
    (() => {
      ...
      var t = (t, r) => {
        ...
        r = (self.webpackChunklira = self.webpackChunklira || []);
  ...
  const o = function () {
    return (0, a.jsxs)(a.Fragment, {
      children: [
        ...
        (0, a.jsxs)("div", {
          className:
            "flex overflow-hidden relative justify-center items-center w-full h-screen bg-neutral-950 min-h-[716px]",
          children: [
            (0, a.jsx)("div", {
              className:
                "absolute bg-indigo-700 rounded-full blur-[75px] h-[800px] left-[-200px] opacity-15 top-[-200px] w-[800px]",
            }),
            (0, a.jsx)("div", {
              className:
                "absolute right-0 bottom-0 bg-teal-400 rounded-full blur-[75px] h-[600px] opacity-15 w-[600px]",
            }),
            (0, a.jsxs)("div", {
              className: "relative p-5 text-center z-[1]",
              children: [
                (0, a.jsx)("div", {
                  className:
                    "mb-5 text-5xl font-bold text-transparent bg-clip-text leading-[72px] max-md:text-4xl max-md:leading-[60px] max-sm:text-3xl max-sm:leading-10",
                  children: "Welcome to Lira",
                }),
                (0, a.jsx)("div", {
                  className:
                    "mx-auto mt-0 mb-11 text-lg leading-7 max-w-[450px] text-neutral-400 max-md:text-base max-md:leading-6 max-md:max-w-[400px] max-sm:mb-8 max-sm:text-sm max-sm:leading-5 max-sm:max-w-[300px]",
                  children:
                    "Share your music with the world. Build your portfolio. Connect with fans.",
                }),
                (0, a.jsxs)("div", {
                  className:
                    "flex gap-4 justify-center max-md:flex-col max-md:items-center",
                  children: [
                    (0, a.jsx)("button", {
                      className:
                        "px-0 py-4 text-base font-semibold leading-6 text-white bg-indigo-700 rounded-lg transition-opacity cursor-pointer border-[none] duration-[0.2s] w-[242px] max-sm:w-full max-sm:max-w-[242px]",
                      children: "Log In",
                    }),
                    (0, a.jsx)("button", {
                      className:
                        "px-0 py-4 text-base font-semibold leading-6 text-white rounded-lg transition-opacity cursor-pointer bg-zinc-800 border-[none] duration-[0.2s] w-[242px] max-sm:w-full max-sm:max-w-[242px]",
                      children: "Sign Up",
                    }),
                  ],
                }),
  ...
  l
    ...
    .render((0, a.jsx)(r.StrictMode, { children: (0, a.jsx)(i, {}) })),
    u();
})();
//# sourceMappingURL=main.638dcffa.js.map
